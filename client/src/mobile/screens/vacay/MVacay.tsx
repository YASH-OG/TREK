          ...
          <div className="mt-2 flex items-center gap-3 rounded-[18px] border border-[color:var(--m-gbr)] bg-[color:var(--m-glass)] px-[14px] py-[9px]">
            ...
            <div className="min-w-0 flex-1">
              ...
              <div className="mt-[6px] flex items-center">
                <span
                  className="inline-flex items-baseline gap-[4px] rounded-full px-[9px] py-[3px] font-geist text-[0.625rem] font-extrabold"
                  style={{ background: `${leftColor}1f`, border: `1px solid ${leftColor}59`, color: leftColor }}
                >
                  <span className="text-[0.8125rem] leading-none tabular-nums">{fmtDays(stat.remaining)}</span>
                  {t('mobileVacay.left')}
                </span>
              </div>
            </div>
